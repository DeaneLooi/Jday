...
public class Sport extends BackgroundPanel {
	...
	private void initialize(){
		...
		lblIcon.setIcon(new ImageIcon(Sport.class.getResource("/images/badminton.png")));
		lblIcon.setBounds(362, 46, 103, 101);
		add(lblIcon);
		
		JLabel lblNewLabel_4 = new JLabel("iconBasketball");
		lblNewLabel_4.setIcon(new ImageIcon(Sport.class.getResource("/images/basketball.png")));
		lblNewLabel_4.setBounds(81, 46, 103, 108);
		add(lblNewLabel_4);
		
		JLabel lblIcontennis = new JLabel("iconTennis");
		lblIcontennis.setIcon(new ImageIcon(Sport.class.getResource("/images/tennis.png")));
		lblIcontennis.setBounds(81, 196, 103, 102);
		add(lblIcontennis);
		
		JLabel lblIconvolley = new JLabel("iconVolley");
		lblIconvolley.setIcon(new ImageIcon(Sport.class.getResource("/images/volleyball.png")));
		lblIconvolley.setBounds(362, 193, 103, 101);
		add(lblIconvolley);
		
		JLabel lblIconbowling = new JLabel("iconBowling");
		lblIconbowling.setIcon(new ImageIcon(Sport.class.getResource("/images/bowling.png")));
		...
		btnViewDetails_1.setBounds(490, 455, 117, 23);
		...
		lblNewLabel_5.setIcon(new ImageIcon(Sport.class.getResource("/images/ttennis.png")));
